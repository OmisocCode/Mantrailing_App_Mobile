...
# (str) Package name
package.name = mantrailing

# (str) Package domain (needed for android/ios packaging)
package.domain = org.mantrailing
...
source.exclude_dirs = tests, bin, .git, .buildozer, venv
...
# (list) Permissions
android.permissions = INTERNET,ACCESS_FINE_LOCATION,ACCESS_COARSE_LOCATION,ACCESS_BACKGROUND_LOCATION,WRITE_EXTERNAL_STORAGE,READ_EXTERNAL_STORAGE,WAKE_LOCK,VIBRATE
